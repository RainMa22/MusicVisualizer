...
public class SettingsManager {
    ...
    public Object getObj(String key) {
        ...
        switch (entry.getType()) {
            ...
            default:
                return get(key);
            case DOUBLE:
                return new Numerical<Double>(Double.parseDouble(get(key)));
            case INT:
                return new Numerical<Integer>(Integer.parseInt(get(key)));
            case IMAGE:
    ...
    public Numerical<Integer> getInt(String key, Numerical<Integer> defaultVal) {
        Numerical<Integer> val;
        try {
            val = new Numerical<>(Integer.parseInt(get(key)));
        } catch (NumberFormatException nfe) {
            val = defaultVal;
    ...
    public ColorRGBA getColor(String key, ColorRGBA defaultVal) {
        ColorRGBA val;
        try {
            val = new ColorRGBA(Integer.decode(get(key)));
        } catch (NumberFormatException nfe) {
            val = defaultVal;
